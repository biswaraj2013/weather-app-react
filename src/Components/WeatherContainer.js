...
function WeatherContainer() {
    ...
    const fetchData = async () => {
        let url = `http://api.weatherapi.com/v1/forecast.json?key=${API_Key}&q=${value.state.city}&days=7&aqi=yes&alerts=no`
    ...
    return (
        <div>
            <div className="weather-container">
                ...
                <div className="container-md-10 d-flex align-items-center justify-content-center text-dark rounded fs-4 overflow-y-auto" style={{ margin: '100px auto', fontFamily: "'Unbounded', cursive", width: '68rem', height: '20rem', backgroundColor: 'blueviolet', padding: '16px 55px', boxShadow: '0px 0px 111px 6px rgba(102,82,122,1)' }}>
